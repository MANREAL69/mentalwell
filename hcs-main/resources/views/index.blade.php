...
@section('content')
    <section class="home py-5 d-flex align-items-center" id="header">
        <div class="container text-light py-5"> 
            <h1 class="headline">Empowering <br/> Your <span class="home_text">Mental Wellness</span></br> Journey, Anytime, Anywhere</h1>
            ...
            <div class="my-3 d-flex justify-content-start">
                ...
                <a class="btn-reverse mx-3" href="#">Why MentalWell?</a>
            </div>
        </div>
    </section>
@endsection